...
where (address_period_start is null or
address_period_start between '01JAN2009'd and '31DEC2021'd);
run;
/* log counts */
proc sql;
...
inner join local.broad_ckd_cht as cht
on cht.patid = cdm.patid
where (coalesce(obsgen_start_date, obsgen_stop_date) is null
or coalesce(obsgen_start_date, obsgen_stop_date) between '01JAN2009'd and '31DEC2021'd)
and (obsgen_code = '42026-5' or
